...
$pshBackupFile = "C:\Users\$user\windows11-build\setup\configurations\psmux\Microsoft.PowerShell_profile.ps1"
$pshTargetDir = "C:\Users\Showen\Documents\PowerShell\"
...
Copy-Item -Path $pshBackupFile -Destination $pshTargetDir -Recurse -Force
